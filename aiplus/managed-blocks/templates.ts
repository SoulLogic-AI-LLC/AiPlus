...
/** All three managed blocks in order. */
export const ALL_BLOCKS = [REPLY_FORMAT, EVIDENCE_DONE, ORCHESTRATOR_CONTRACT]

/** Block names for verification. */
export const BLOCK_NAMES = ["reply-format", "evidence-done", "orchestrator-contract"]
