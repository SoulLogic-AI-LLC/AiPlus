...
const high_risk_keywords: readonly string[] = [
  "owner_gate", "owner gate", "push to", "release to", "deploy to",
  "payment", "override instruction", "override current instruction",
  "ignore previous instruction", "api key", "api_key", "apikey",
  "secret", "token", "cookie", "activate skill", "skill activation",
  "global config", "global configuration", "edit config",
  "begin transcript", "webvtt", "provider request body",
  "provider response body",
]

const high_risk_types: readonly string[] = [
  "owner_gate", "payment", "secret", "token", "api_key",
  "cookie", "transcript", "skill_activation", "global_config",
]

const low_risk_types: readonly string[] = [
  "owner_preference", "style_preference", "formatting_preference",
  "language_preference", "project_fact", "verified_project_structure",
  "file_location", "workflow_rule", "common_command",
  "verified_bug_fix", "bug_fix_lesson",
]

const medium_risk_types: readonly string[] = [
  "project_decision", "architecture_decision", "release_checklist",
  "cross_project_pattern", "risk", "recurring_failure",
  "skill_candidate", "draft_proposal", "model_preference",
  "provider_preference",
]

const low_risk_keywords: readonly string[] = [
  "style preference", "formatting preference", "language preference",
  "use spaces", "use tabs", "indent with", "file is located at",
  "project structure", "common command", "how to build",
  "build command", "test command", "verified bug fix", "bug fix lesson",
]

const medium_risk_keywords: readonly string[] = [
  "architecture decision", "decided to use", "release checklist",
  "cross-project", "recurring failure", "failure pattern",
  "skill candidate", "draft proposal", "model preference",
  "provider preference", "prefer to use", "recommend using",
]
